      ...
      <main className="flex-1">
        ...
        <section className="relative py-12 bg-gray-50 dark:bg-black">
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute h-64 w-64 border border-gray-200 dark:border-gray-800 rounded-full -top-32 -left-32" />
            <div className="absolute h-96 w-96 border border-gray-200 dark:border-gray-800 rounded-full -bottom-48 -right-48" />
          </div>
