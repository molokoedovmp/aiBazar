...
type InputProps = {
  ...
  disabled?: boolean;
  dropzoneOptions?: Omit<DropzoneOptions, 'недоступен'>;
};

const ERROR_MESSAGES = {
  fileTooLarge(maxSize: number) {
    return `Файл слишком велик. Максимальный размер равен ${formatFileSize(maxSize)}.`;
  },
  fileInvalidType() {
    return 'Недопустимый тип файла.';
  },
  tooManyFiles(maxFiles: number) {
    return `Вы можете добавить только ${maxFiles} файл(ы).`;
  },
  fileNotSupported() {
